...
import {Category, Choices, QuestionCard} from '../clientInterfaces'; // questionInterfaces
import {knex, RefreshTables} from './db';
import {tableAnswers, tableQuestions} from './dbConfig';
import {Answer, Question} from './dbTypes';
